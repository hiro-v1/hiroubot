...
• ᴄᴏᴍᴍᴀɴᴅ: <code>{0}song</code> [ꜱᴏɴɢ ᴛɪᴛʟᴇ]
• ᴇxᴘʟᴀɴᴀᴛɪᴏɴ: ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴏᴡɴʟᴏᴀᴅ ᴍᴜꜱɪᴄ ʏᴀɴɢ ᴅɪɪɴɢɪɴᴋᴀɴ.

• ᴄᴏᴍᴍᴀɴᴅ: <code>{0}vsong</code> [ᴠɪᴅᴇᴏ ᴛɪᴛʟᴇ]
• ᴇxᴘʟᴀɴᴀᴛɪᴏɴ: ᴜɴᴛᴜᴋ ᴍᴇɴᴅᴏᴡɴʟᴏᴀᴅ ᴠɪᴅᴇᴏ ʏᴀɴɢ ᴅɪɪɴɢɪɴᴋᴀɴ.</b></blockquote>
"""
import asyncio
import math
import os

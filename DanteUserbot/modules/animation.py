...
from DanteUserbot.core.helpers.tools import edit_or_reply, get_text
from DanteUserbot.core.helpers.constants import MEMES
...
@DANTE.UBOT("hujan")
async def hujan(ubot: ubot, message: Message):
    e = await edit_or_reply(message, "☁️🌈===☁️")
    await e.edit("☁️=🌈==☁️")
    await e.edit("☁️==🌈=☁️")
    await e.edit("☁️===🌈☁️")
    await e.edit("☁️==🌈=☁️")
